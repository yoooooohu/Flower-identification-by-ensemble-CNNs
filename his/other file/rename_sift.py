...
txt1_1 = root+'train1_3.txt'
txt2 = root+'test1.txt'
txt2_1 = root+'test1_3.txt'
mat_loc = root+'zero_index_size_pict.mat'
...
wrong_index = sio.loadmat(mat_loc)['zero_index']
...
for ip in imgs_data1:
	...
	ip[0] = ip[0].replace('segmim', 'sift_segmim',1)		#只替换一次
...
for ip in imgs_data1:
	n_index = int(ip[0][26:31])
	if n_index not in wrong_index:
		fh1_1.write(ip[0])
		fh1_1.write("\t")
